...
const BlockForm = () => {
    ...
    return (
        <Modal closeHandler={() => appDispatch(ttBlockFormClosed())} height='80%'>
            <s.BlockFormContainer>
                <s.BlockFormMain>
                    ...
                    <s.BodySectionContainer>
                        <AnimatePresence>
                            {state.additionals.map(ad => (
                                <AdditionalsComponent
                                    key={ad.id}
                                    data={ad}
                                    updateHandler={data => formDispatch(fa.updateAdditional(data))}
                                    deleteHandler={id => formDispatch(fa.deleteAdditional(id))}
                                />
                            ))}
                        </AnimatePresence>
                        <s.AdditionalsButtonContainer>
                            <s.AdditionalsButton onClick={() => formDispatch(fa.addNewAdditionals())}>
                                Add details
                            </s.AdditionalsButton>
                        </s.AdditionalsButtonContainer>
                    </s.BodySectionContainer>
